...
void Bridge(int a, int b, int n, WashGraph *G);
void Gadget(int a, int b, int n, int m, int c, WashGraph *G);
void InitGraph(WashGraph *G);
int NewVertex(WashGraph *G);
void Sink(int k, WashGraph *G);
Edge *EdgeLookup(int v1, int v2, WashGraph *G);
void AddVertex(int v, WashGraph *G);
void Barf(char *s);
int RandomInteger (int low, int high);
void RandomSubset(int low, int high, int n, int *x);
void WriteVertex(int v, WashGraph *G, FILE *f);
void WriteVertex2(int v, WashGraph *G, FILE *f);
void WriteVertex3(int v, WashGraph *G, FILE *f);
char ReadChar(FILE *f);

void AddEdge(int v1, int v2, int a, WashGraph* G)
{
...
WashGraph *Mesh(int d1, int d2, int r)
{
	WashGraph *G;
	int i, j, source, sink;
	...
	G = (WashGraph *) malloc(sizeof(WashGraph));
...
WashGraph *RLevel(int d1, int d2, int r)
{
	WashGraph *G;
...
WashGraph *R2Level(int d1, int d2, int r)
{
	WashGraph *G;
	int i, j, source, sink, x[3];
...
WashGraph *SquareMesh(int d, int deg, int r)
{
	WashGraph *G;
...
WashGraph *BasicLine(int n, int m, int deg)
{
	WashGraph *G;
...
WashGraph *ExponentialLine(int n, int m, int deg)
{
	WashGraph *G;
...
WashGraph *DExponentialLine(int n, int m, int deg)
{
	WashGraph *G;
	int i, j, source, sink, x[MAX_DEGREE], r;
...
WashGraph *Cheryian(int n, int m, int c)
{
	WashGraph *G;
	int i;
...
WashGraph *CopyGraph(WashGraph *G1)
{
	int i;
	Edge *e;
	WashGraph *G2;

	G2 = (WashGraph *) malloc(sizeof(WashGraph));
	InitGraph(G2);
...
void UEdgeArray(Edge *E[], int m, WashGraph *G)
{
	int i, count;
	Edge *e;
...
WashGraph *InputFlowGraph(FILE *f, int *s, int *t)
{
...
WashGraph *InputFlow(FILE *f, WashGraph *G, int *s)
{
	char c, c1, ReadChar(), buff[100];
...
void GraphOutput(WashGraph *G, FILE *f, int s, int t)
{
	int i;
...
void OutputFlow(WashGraph *G, FILE *f, int s)
{
	int i;
...
void PrintFlow(WashGraph *G, int s)
{
	OutputFlow(G, stdout, s);
}

void PrintGraph(WashGraph *G)
{
	int i;
...
{
	WashGraph *G;//, *Mesh(), *RLevel(), *R2Level(), *Match(), *SquareMesh(), 
